...
# %%
# DSNY_waste[["YEAR", "MGP", "ORGANICS", "PAPER", "REFUSE"]].groupby(['YEAR'], as_index=False).sum() this works great, the variables are ordered correctly, and we groupby the year. as_index=F creates a dataframe
...
"""
## Optional
### I attempted the stacked plot with the 'altair' package. Ultimately, I wasn't able to create a stacked plot with all four tonnage variables included in a single plot. However, altair has its advantages, as I like it's 'interactive()' feature. Below are altair area plots of each individual waste tonnage variable. 
### These plots are best used and displayed inside a Jupyter Notebook. 
"""
